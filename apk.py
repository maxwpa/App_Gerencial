...
def tabela():
    if hasattr(st.session_state, 'logged_in') and st.session_state.logged_in:
        ...
        if filtro_produto:
            ...
            (df_compras['produto'].isin(filtro_produto)) &
            (df_compras['tamanho'].isin(filtro_tamanho)) &
            (df_compras['genero'].isin(filtro_genero)) &
            (df_compras['publico'].isin(filtro_publico)) &
            (df_compras['fornecedor'].isin(filtro_fornecedor))
        ]
